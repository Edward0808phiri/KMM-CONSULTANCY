...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/70 backdrop-blur-md shadow-md fixed top-0 left-0 w-full z-50 transition">
      ...
      {isOpen && (
        <div className="md:hidden bg-white/90 backdrop-blur-md shadow-md px-4 py-3 space-y-3">
          <Link
            to="/"
